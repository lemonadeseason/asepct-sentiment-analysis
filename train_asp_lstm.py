...
from asp_lstm_trainer import LSTMTrainer
...
parser.add_argument('--rnn_hidden', type=int, default=50, help='RNN hidden state size.')      #因为是bi-LSTM，要使lstm embedding为50，则hidden_size因设为25？
...
parser.add_argument('--save_dir', type=str, default='./saved_models_asp_lstm', help='Root dir for saving models.')
...
# build model
trainer = LSTMTrainer(args, emb_matrix=word_emb)
