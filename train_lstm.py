...
parser.add_argument('--bidirect', default=False, help='Do use bi-RNN layer.')
...
parser.add_argument('--save_dir', type=str, default='./saved_models_lstm', help='Root dir for saving models.')
